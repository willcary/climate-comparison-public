...
function ContextProvider({children}) {
    ...
    const [climateDataOne, setClimateDataOne] = useState([
        {month: 1, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 2, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 3, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 4, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 5, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 6, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 7, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 8, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 9, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 10, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 11, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0},
        {month: 12, prcp: 0, pres: 0, tavg: 0, tmax: 0, tmin: 0, tsun: null, wspd: 0}
    ]);
    ...
    const baseGeocodeUrl = "https://open.mapquestapi.com/geocoding/v1/address?key=" + process.env.REACT_APP_GEOCODE_API_KEY + "&location=";
    ...
    function prepClimateUrl(lat, lng) {
        const baseWeatherStationURL = "https://meteostat.p.rapidapi.com/point/normals?lat=";
